...
namespace Tester
{
    public partial class PowerfulSample : Form
    {
        ...
        void GoLeftBracket(FastColoredTextBoxNS.FastColoredTextBox tb, char leftBracket, char rightBracket)
        {
        ...
        void GoRightBracket(FastColoredTextBoxNS.FastColoredTextBox tb, char leftBracket, char rightBracket)
        {
        ...
        {
            var styles = new Style[] { fctb.SyntaxHighlighter.BlueBoldStyle, fctb.SyntaxHighlighter.BlueStyle, fctb.SyntaxHighlighter.BoldStyle, fctb.SyntaxHighlighter.BrownStyle, fctb.SyntaxHighlighter.GrayStyle, fctb.SyntaxHighlighter.GreenStyle, fctb.SyntaxHighlighter.MagentaStyle, fctb.SyntaxHighlighter.RedStyle };
