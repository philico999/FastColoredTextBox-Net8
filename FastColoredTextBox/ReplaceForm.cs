...
{
    public partial class ReplaceForm : FctbForm
    {
        ...
        public bool Find(string pattern)
        {
            ...
            range.Normalize();
            //
            if (firstSearch || cbWrapSearches.Checked)
            {
        ...
        private void btReplaceAll_Click(object sender, EventArgs e)
        {
            ...
            {
                //cp - added 2/21/2023
                if (tb.Selection.IsEmpty || tb.Selection.FromLine == tb.Selection.ToLine)
                {
                    tb.SelectAll();
                }
        ...
        {
            tbFind.Select(0, tbFind.Text.Length);
        }

        private void tbReplace_Enter(object sender, EventArgs e)
        {
            tbReplace.Select(0, tbReplace.Text.Length);
        }
    }
}
