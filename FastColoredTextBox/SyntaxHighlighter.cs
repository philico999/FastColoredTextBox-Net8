...
namespace FastColoredTextBoxNS
{
    public class SyntaxHighlighter : IDisposable
    {
        ...
        // ============================================================================
        // PLATFORM AND BASE STYLES
        // ============================================================================
        protected static readonly Platform platformType = PlatformType.GetOperationSystemPlatform();

        // Keep this base style for special formatting needs
        public readonly TextStyle BoldStyle = new TextStyle(null, null, FontStyle.Bold | FontStyle.Underline);

        // ============================================================================
        // C# LANGUAGE STYLES
        // ============================================================================
        public readonly TextStyle CommentCs = new TextStyle(Brushes.Green, null, FontStyle.Italic);
        public readonly TextStyle StringCs = new TextStyle(Brushes.Brown, null, FontStyle.Italic);
        public readonly TextStyle NumberCs = new TextStyle(Brushes.Magenta, null, FontStyle.Regular);
        public readonly TextStyle KeywordCs = new TextStyle(Brushes.DodgerBlue, null, FontStyle.Regular);
        public readonly TextStyle AttributeCs = new TextStyle(Brushes.Green, null, FontStyle.Italic);
        public readonly TextStyle ClassNameCs = new TextStyle(null, null, FontStyle.Bold | FontStyle.Underline);
        public readonly TextStyle CommentTagCs = new TextStyle(Brushes.Gray, null, FontStyle.Regular);

        // ============================================================================
        // VB LANGUAGE STYLES
        // ============================================================================
        public readonly TextStyle CommentVb = new TextStyle(Brushes.Green, null, FontStyle.Italic);
        public readonly TextStyle StringVb = new TextStyle(Brushes.Brown, null, FontStyle.Italic);
        public readonly TextStyle NumberVb = new TextStyle(Brushes.Magenta, null, FontStyle.Regular);
        public readonly TextStyle KeywordVb = new TextStyle(Brushes.DodgerBlue, null, FontStyle.Regular);
        public readonly TextStyle ClassNameVb = new TextStyle(null, null, FontStyle.Bold | FontStyle.Underline);

        // ============================================================================
        // SQL LANGUAGE STYLES
        // ============================================================================
        public readonly TextStyle CommentSql = new TextStyle(Brushes.Green, null, FontStyle.Italic);
        public readonly TextStyle StringSql = new TextStyle(Brushes.OrangeRed, null, FontStyle.Regular);
        public readonly TextStyle NumberSql = new TextStyle(Brushes.Magenta, null, FontStyle.Regular);
        public readonly TextStyle KeywordSql = new TextStyle(Brushes.RoyalBlue, null, FontStyle.Bold);
        public readonly TextStyle StatementsSql = new TextStyle(Brushes.DodgerBlue, null, FontStyle.Regular);
        public readonly TextStyle FunctionsSql = new TextStyle(Brushes.Red, null, FontStyle.Regular);
        public readonly TextStyle VariableSql = new TextStyle(Brushes.Red, null, FontStyle.Regular);
        public readonly TextStyle TypesSql = new TextStyle(Brushes.Brown, null, FontStyle.Italic);

        // ============================================================================
        // HTML LANGUAGE STYLES
        // ============================================================================
        public readonly TextStyle CommentHtml = new TextStyle(Brushes.Green, null, FontStyle.Italic);
        public readonly TextStyle TagBracketHtml = new TextStyle(Brushes.DodgerBlue, null, FontStyle.Regular);
        public readonly TextStyle TagNameHtml = new TextStyle(Brushes.Red, null, FontStyle.Regular);
        public readonly TextStyle AttributeHtml = new TextStyle(Brushes.OrangeRed, null, FontStyle.Regular);
        public readonly TextStyle AttributeValueHtml = new TextStyle(Brushes.DodgerBlue, null, FontStyle.Regular);
        public readonly TextStyle EntityHtml = new TextStyle(Brushes.OrangeRed, null, FontStyle.Regular);

        // ============================================================================
        // XML LANGUAGE STYLES
        // ============================================================================
        public readonly TextStyle CommentXml = new TextStyle(Brushes.Green, null, FontStyle.Italic);
        public readonly TextStyle TagBracketXml = new TextStyle(Brushes.DodgerBlue, null, FontStyle.Regular);
        public readonly TextStyle TagNameXml = new TextStyle(Brushes.Red, null, FontStyle.Regular);
        public readonly TextStyle AttributeXml = new TextStyle(Brushes.OrangeRed, null, FontStyle.Regular);
        public readonly TextStyle AttributeValueXml = new TextStyle(Brushes.DodgerBlue, null, FontStyle.Regular);
        public readonly TextStyle EntityXml = new TextStyle(Brushes.OrangeRed, null, FontStyle.Regular);
        public readonly TextStyle CDataXml = new TextStyle(Brushes.Black, null, FontStyle.Regular);
        public readonly TextStyle StringXml = new TextStyle(Brushes.OrangeRed, null, FontStyle.Regular);

        // ============================================================================
        // JAVASCRIPT LANGUAGE STYLES
        // ============================================================================
        public readonly TextStyle CommentJs = new TextStyle(Brushes.Green, null, FontStyle.Italic);
        public readonly TextStyle StringJs = new TextStyle(Brushes.Brown, null, FontStyle.Italic);
        public readonly TextStyle NumberJs = new TextStyle(Brushes.Magenta, null, FontStyle.Regular);
        public readonly TextStyle KeywordJs = new TextStyle(Brushes.DodgerBlue, null, FontStyle.Regular);

        // ============================================================================
        // LUA LANGUAGE STYLES
        // ============================================================================
        public readonly TextStyle CommentLua = new TextStyle(Brushes.Green, null, FontStyle.Italic);
        public readonly TextStyle StringLua = new TextStyle(Brushes.Brown, null, FontStyle.Italic);
        public readonly TextStyle NumberLua = new TextStyle(Brushes.Magenta, null, FontStyle.Regular);
        public readonly TextStyle KeywordLua = new TextStyle(Brushes.RoyalBlue, null, FontStyle.Bold);
        public readonly TextStyle FunctionsLua = new TextStyle(Brushes.Red, null, FontStyle.Regular);

        // ============================================================================
        // PHP LANGUAGE STYLES
        // ============================================================================
        public readonly TextStyle CommentPhp = new TextStyle(Brushes.Green, null, FontStyle.Italic);
        public readonly TextStyle StringPhp = new TextStyle(Brushes.OrangeRed, null, FontStyle.Regular);
        public readonly TextStyle NumberPhp = new TextStyle(Brushes.OrangeRed, null, FontStyle.Regular);
        public readonly TextStyle KeywordPhp = new TextStyle(Brushes.Magenta, null, FontStyle.Regular);
        public readonly TextStyle Keyword2Php = new TextStyle(Brushes.DodgerBlue, null, FontStyle.Regular);
        public readonly TextStyle Keyword3Php = new TextStyle(Brushes.Gray, null, FontStyle.Regular);
        public readonly TextStyle VariablePhp = new TextStyle(Brushes.Red, null, FontStyle.Regular);

        // ============================================================================
        // JSON LANGUAGE STYLES
        // ============================================================================
        public readonly TextStyle CommentJson = new TextStyle(Brushes.Green, null, FontStyle.Italic);
        public readonly TextStyle StringJson = new TextStyle(Brushes.Brown, null, FontStyle.Italic);
        public readonly TextStyle NumberJson = new TextStyle(Brushes.Magenta, null, FontStyle.Regular);
        public readonly TextStyle KeywordJson = new TextStyle(Brushes.DodgerBlue, null, FontStyle.Regular);
        ...
        protected FastColoredTextBox _fctb;
        ...
        /// <summary>
        /// Produces a new <see cref="TextStyle"/> whose foreground brush is adjusted
        /// to ensure adequate luminance contrast against the style’s
        /// <see cref="TextStyle.BackgroundBrush"/>.
        /// </summary>
        /// <param name="textStyle">
        /// The original <see cref="TextStyle"/> whose foreground color may be adjusted.
        /// If <paramref name="textStyle"/> is <c>null</c>, or if its
        /// <see cref="TextStyle.BackgroundBrush"/> is <c>null</c> or not a
        /// <see cref="SolidBrush"/>, the original style is returned unchanged.
        /// </param>
        /// <returns>
        /// A new <see cref="TextStyle"/> instance with an adjusted foreground brush
        /// when contrast enhancement is possible; otherwise the original
        /// <paramref name="textStyle"/>.
        /// </returns>
        /// <remarks>
        /// This method uses <see cref="ColorHelper.AdjustContrast(Brush, Brush, int)"/>
        /// to enforce a minimum luminance difference between the foreground and
        /// background brushes. Only <see cref="SolidBrush"/> backgrounds can be
        /// evaluated for contrast; other brush types are returned unchanged.
        /// The returned <see cref="TextStyle"/> maintains all properties of the
        /// original except for the adjusted <see cref="TextStyle.ForeBrush"/>.
        /// </remarks>
        public virtual TextStyle AdjustTextStyleContrast(TextStyle textStyle)
        {
            if (textStyle == null)
                return null;
            ...
            if (textStyle.BackgroundBrush is not SolidBrush)
                return textStyle;

            Brush adjustedFore = ColorHelper.AdjustContrast(
                textStyle.ForeBrush,
                textStyle.BackgroundBrush
            );

            return new TextStyle(adjustedFore, textStyle.BackgroundBrush, textStyle.FontStyle)
            {
                CustomFont = textStyle.CustomFont,
                stringFormat = textStyle.stringFormat
            };
        }

        /// <summary>
        /// Produces a new <see cref="TextStyle"/> whose foreground brush is adjusted
        /// to ensure adequate luminance contrast against the specified background
        /// <see cref="Color"/>.
        /// </summary>
        /// <param name="textStyle">
        /// The original <see cref="TextStyle"/> whose foreground color may be adjusted.
        /// If <paramref name="textStyle"/> is <c>null</c>, or if
        /// <paramref name="backColor"/> is the default uninitialized color,
        /// the original style is returned unchanged.
        /// </param>
        /// <param name="backColor">
        /// The background <see cref="Color"/> used as the luminance reference when
        /// computing contrast. If this value is <c>default(Color)</c>, no
        /// contrast adjustment is performed.
        /// </param>
        /// <returns>
        /// A new <see cref="TextStyle"/> containing an adjusted foreground brush when
        /// contrast enhancement is required; otherwise the original
        /// <paramref name="textStyle"/>.
        /// </returns>
        /// <remarks>
        /// This method uses <see cref="ColorHelper.AdjustContrast(Brush, Color, int)"/>
        /// to enforce a minimum luminance separation between the foreground
        /// brush and the provided background color. All other properties of
        /// <paramref name="textStyle"/> are preserved in the returned instance.
        /// </remarks>
        public virtual TextStyle AdjustTextStyleContrast(TextStyle textStyle, Color backColor)
        {
            if (textStyle == null)
                return null;
            ...
            textStyle.ForeBrush = textStyle.ForeBrush ?? new SolidBrush(Color.Gray);

            using Brush adjustedFore = new SolidBrush(ColorHelper.AdjustContrast(backColor, Color.Gray));
        ...
        public virtual void AddResilientStyle(Style style)
        {
            ...
            _fctb.CheckStylesBufferSize(); // Prevent buffer overflow
        ...
        // ============================================================================
        // UPDATED InitStyleSchema METHOD
        // ============================================================================
        public void InitStyleSchema(Language lang, Color backColor)
        {
            switch (lang)
            {
                case Language.CSharp:
                    StringStyle = AdjustTextStyleContrast(StringCs, backColor);
                    CommentStyle = AdjustTextStyleContrast(CommentCs, backColor);
                    NumberStyle = AdjustTextStyleContrast(NumberCs, backColor);
                    AttributeStyle = AdjustTextStyleContrast(AttributeCs, backColor);
                    ClassNameStyle = AdjustTextStyleContrast(ClassNameCs, backColor);
                    KeywordStyle = AdjustTextStyleContrast(KeywordCs, backColor);
                    CommentTagStyle = AdjustTextStyleContrast(CommentTagCs, backColor);
                    break;

                case Language.VB:
                    StringStyle = AdjustTextStyleContrast(StringVb, backColor);
                    CommentStyle = AdjustTextStyleContrast(CommentVb, backColor);
                    NumberStyle = AdjustTextStyleContrast(NumberVb, backColor);
                    ClassNameStyle = AdjustTextStyleContrast(ClassNameVb, backColor);
                    KeywordStyle = AdjustTextStyleContrast(KeywordVb, backColor);
                    break;

                case Language.HTML:
                    CommentStyle = AdjustTextStyleContrast(CommentHtml, backColor);
                    TagBracketStyle = AdjustTextStyleContrast(TagBracketHtml, backColor);
                    TagNameStyle = AdjustTextStyleContrast(TagNameHtml, backColor);
                    AttributeStyle = AdjustTextStyleContrast(AttributeHtml, backColor);
                    AttributeValueStyle = AdjustTextStyleContrast(AttributeValueHtml, backColor);
                    HtmlEntityStyle = AdjustTextStyleContrast(EntityHtml, backColor);
                    break;

                case Language.XML:
                    CommentStyle = AdjustTextStyleContrast(CommentXml, backColor);
                    XmlTagBracketStyle = AdjustTextStyleContrast(TagBracketXml, backColor);
                    XmlTagNameStyle = AdjustTextStyleContrast(TagNameXml, backColor);
                    XmlAttributeStyle = AdjustTextStyleContrast(AttributeXml, backColor);
                    XmlAttributeValueStyle = AdjustTextStyleContrast(AttributeValueXml, backColor);
                    XmlEntityStyle = AdjustTextStyleContrast(EntityXml, backColor);
                    XmlCDataStyle = AdjustTextStyleContrast(CDataXml, backColor);
                    break;

                case Language.JS:
                    StringStyle = AdjustTextStyleContrast(StringJs, backColor);
                    CommentStyle = AdjustTextStyleContrast(CommentJs, backColor);
                    NumberStyle = AdjustTextStyleContrast(NumberJs, backColor);
                    KeywordStyle = AdjustTextStyleContrast(KeywordJs, backColor);
                    break;

                case Language.Lua:
                    StringStyle = AdjustTextStyleContrast(StringLua, backColor);
                    CommentStyle = AdjustTextStyleContrast(CommentLua, backColor);
                    NumberStyle = AdjustTextStyleContrast(NumberLua, backColor);
                    KeywordStyle = AdjustTextStyleContrast(KeywordLua, backColor);
                    FunctionsStyle = AdjustTextStyleContrast(FunctionsLua, backColor);
                    break;

                case Language.PHP:
                    StringStyle = AdjustTextStyleContrast(StringPhp, backColor);
                    CommentStyle = AdjustTextStyleContrast(CommentPhp, backColor);
                    NumberStyle = AdjustTextStyleContrast(NumberPhp, backColor);
                    VariableStyle = AdjustTextStyleContrast(VariablePhp, backColor);
                    KeywordStyle = AdjustTextStyleContrast(KeywordPhp, backColor);
                    KeywordStyle2 = AdjustTextStyleContrast(Keyword2Php, backColor);
                    KeywordStyle3 = AdjustTextStyleContrast(Keyword3Php, backColor);
                    break;

                case Language.SQL:
                    StringStyle = AdjustTextStyleContrast(StringSql, backColor);
                    CommentStyle = AdjustTextStyleContrast(CommentSql, backColor);
                    NumberStyle = AdjustTextStyleContrast(NumberSql, backColor);
                    KeywordStyle = AdjustTextStyleContrast(KeywordSql, backColor);
                    StatementsStyle = AdjustTextStyleContrast(StatementsSql, backColor);
                    FunctionsStyle = AdjustTextStyleContrast(FunctionsSql, backColor);
                    VariableStyle = AdjustTextStyleContrast(VariableSql, backColor);
                    TypesStyle = AdjustTextStyleContrast(TypesSql, backColor);
                    break;

                case Language.JSON:
                    StringStyle = AdjustTextStyleContrast(StringJson, backColor);
                    NumberStyle = AdjustTextStyleContrast(NumberJson, backColor);
                    KeywordStyle = AdjustTextStyleContrast(KeywordJson, backColor);
                    break;
            }
        }
